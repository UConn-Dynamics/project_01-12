...
anim = @animate for i in 1:5:length(sol.t)
    ...
    plot!([0, w1*cos(omega*sol.t[i])],
          [0, w1*sin(omega*sol.t[i])],
          [0, 0])

    # Pendulum rod
    plot!([w1*cos(omega*sol.t[i]), x_vals[i]],
          [w1*sin(omega*sol.t[i]), y_vals[i]],
          [0, z_vals[i]])
...
# ╔═╡ 1a453a6a-134c-4e88-872f-cdba06b19436
# -------------------------
# Time Series Plot
# -------------------------
...
# ╔═╡ bf1c9669-cf81-4872-a0a4-d112dd40d52c
# -------------------------
# Phase Plot
# -------------------------
...
# ╔═╡ f8d8e567-f075-45f3-8035-5be481ea0835


# ╔═╡ d4b908b8-2eee-44b1-b89a-c5f546afc5fd
# -------------------------
# 2. ANGULAR SPEED vs TIME
# -------------------------
...
# ╔═╡ d5188907-6b03-4616-a40d-bd9428c82e09
begin
	# -------------------------
	# 3. PENDULUM MOTION (TRAJECTORY)
	# -------------------------
...
# ╔═╡ 7cd8f97d-a1e8-463d-ba34-14daff81c109
# -------------------------
# OPTIONAL: ANIMATION
# -------------------------
